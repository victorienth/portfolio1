...
export default function Page() {
  ...
  // === CV par langue (mets ces PDFs dans /public) ===
  // /public/CV_VictorienThomas_FR.pdf
  // /public/CV_VictorienThomas_EN.pdf
  // /public/CV_VictorienThomas_ES.pdf (optionnel)
  const cvHref =
    lang === "en"
      ? "/CV_VictorienThomas_EN.pdf"
      : lang === "es"
        ? "/CV_VictorienThomas_ES.pdf"
        : "/CV_VictorienThomas_FR.pdf";

  // (Optionnel) si tu veux aussi un nom de fichier au téléchargement
        ...
        <div className="wrap" style={{ display: "flex", alignItems: "center", gap: "2rem", flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 360px" }}>
            ...
            <div className="socials">
              ...
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/in/victorien-thomas-855776306"
                target="_blank"
                rel="noreferrer"
                className="icon-link"
              >
